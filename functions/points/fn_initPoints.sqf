...
grad_points_playerKilled_civilian = [_cfg >> "CIVILIAN","playerKilled",_playerKilled_default] call BIS_fnc_returnConfigEntry;
...
grad_points_aiKilled_civilian = [_cfg >> "CIVILIAN","aiKilled",_aiKilled_default] call BIS_fnc_returnConfigEntry;
...
grad_points_civKilled_civilian = [_cfg >> "CIVILIAN","civKilled",_civKilled_default] call BIS_fnc_returnConfigEntry;
